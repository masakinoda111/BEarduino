...
#define E1 5 //5
#define E0 10   // 10          //移動時間の設定：keep(E1*abs(d_angle) + E0)
...
void getAngle(){  //読み取ったgの値から機体が向いている方向を計算して、current_angleに代入する
  ...
  gForceX /= (ACmeter_count*1000.0);//読み取った値をgに変換
  gForceY /= (ACmeter_count*1000.0);
  ...
  //https://auth.arduino.cc/reset/save/22e45cdf-e3ad-4f6c-a15a-beb854b1c5fc
